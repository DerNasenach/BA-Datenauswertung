...
def visualize_angle_differences(ax, json_path, name_layer_1, value_type="mean"):
    # plots values for angle metrics
...
if __name__ == "__main__":
    # main execution: plot mean and max angles for all exercises and save figures to .png files
    ...
    bars1_mean, bars2_mean = visualize_angle_differences(
    ...
    bars1_max, bars2_max = visualize_angle_differences(
